...
export const allocateShipment = (id)     => httpRequest(`/sales/shipments/${id}/allocate`, { method: 'POST' })
export const packShipment     = (id)     => httpRequest(`/sales/shipments/${id}/pack`,     { method: 'POST' })
export const dispatchShipment = (id, b)  => httpRequest(`/sales/shipments/${id}/dispatch`, { method: 'POST', body: JSON.stringify(b) })
